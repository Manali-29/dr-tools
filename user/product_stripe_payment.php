<?php 
	...
	if(!empty($_POST['stripeToken'])){
    	...
    	if($chargeJson['amount_refunded'] == 0 && empty($chargeJson['failure_code']) && $chargeJson['paid'] == 1 && $chargeJson['captured'] == 1){ 
			...
			$sql1 = "INSERT INTO `order` (cart_id, sub_total, order_status, card_number, card_exp_month, card_exp_year, transactionID, payment_status, user_id) VALUES ('', '{$row['pro_price']}', 'approved', '$card_no', '$card_exp_month', '$card_exp_year', '$transactionID', '$payment_status', '{$user_id}')";
			...
			$sql4 = "INSERT INTO payment (payment_method, order_id, payment_amount, user_id) VALUES ('Online', '{$order_id}', '{$price}', '{$user_id}')";
        ...
        <div class="row">
	        <div class="col-lg-12">
				<div class="status">
					...
					<br>
					<p><b>Reference ID:</b> <strong><?php echo $order_id; ?></strong></p>
